// src/app/company/courses/leads/seeker/[id]/page.tsx
"use client";
...
import companyCourseEndpoints, { CourseEnrollmentResponse } from "@/lib/api/endpoints/company/companyCourseEndpoints";
...
export default function CompanySeekerView() {
  ...
  const [application, setApplication] = useState<CourseEnrollmentResponse | null>(
    null,
  );
  ...
  const handleBack = () => {
    if (application?.courseId){
      router.push(`/company/courses/leads/${application.courseId}`);
    }
  ...
  const fetchApplication = async () => {
    // setIsLoading(true);
    try {
      const response = await companyCourseEndpoints.enrollments.getEnrollmentById(
        applicationId!,
      );
      const apiResponse = response.data;
  ...
  const handleStatusChange = async (
      ...
      setIsUpdating(true);
      try {
        const response = await seekerCourseAPI.application.updateApplicationStatus(
          applicationId,
          newStatus,
        );
          ...
          <div className="flex items-center gap-3 mt-2 flex-wrap">
            ...
            {application?.status && (
              <Badge className="bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400">
                ...
                {application?.status == "CANCELLED" ? "REJECTED" : application?.status}
              </Badge>
            )}
          </div>
                      ...
                      <>
                        ...
                        <div>
                          <p className="font-semibold text-yellow-800 dark:text-yellow-300">
                            Enrollment is pending review
                          </p>
                          <p className="text-sm text-yellow-700 dark:text-yellow-400">
                            Review the enrollment and take action.
                          </p>
                        </div>
                      </>
                    )}
                      ...
                      <>
                        ...
                        <div>
                          <p className="font-semibold text-blue-800 dark:text-blue-300">
                            Candidate has been enrolled
                          </p>
                          <p className="text-sm text-blue-700 dark:text-blue-400">
                            The candidate has been enrolled in the course.
                          </p>
                        </div>
                      </>
                    )}
                      ...
                      <>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-700 dark:text-red-400">
                            The candidate&apos;s enrollment in the course has been rejected.
                          </p>
                        </div>
                      </>
                    )}
                    ...
                    {application?.status === "PENDING" && (
                      <>
                        <Button
                          ...
                          onClick={() =>
                            handleStatusChange(applicationId!, "ENROLLED")
                          }
                          disabled={isUpdating}
                        >
                        ...
                        <Button
                          ...
                          onClick={() =>
                            handleStatusChange(applicationId!, "CANCELLED")
                          }
                          disabled={isUpdating}
                        >
