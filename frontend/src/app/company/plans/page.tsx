...
import { Check, Crown, Sparkles, Zap, Shield, ArrowLeft } from "lucide-react";
...
export default function PricingPage() {
  ...
  const handlePurchase = (plan: PricingPlan) => {
    ...
    if (!isAuthenticated) {
      ...
      router.push(
        "/auth/login?redirect=/company/plans/checkout?plan=" + plan.id,
      );
      return;
    }
            ...
            {pricingPlans.map((plan) => (
              ...
              >
                ...
                >
                  ...
                  {/* Plan Header */}
                  <div
                    className={`p-4 bg-linear-to-r ${plan.color} text-white`}
                  >
