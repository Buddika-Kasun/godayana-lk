...
export default function LoginPage() {
  ...
  // Mock user data for different credentials
  const mockUsers = [
    {
      id: "1",
    ...
    },
    {
      ...
      avatar:
        "https://ui-avatars.com/api/?name=Tech+Corp&background=0D9488&color=fff",
    },
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      if (user) {
        ...
        storeUserData(userWithoutPassword);
        ...
        setTimeout(() => {
          ...
          if (redirectTo) {
            // If there's a redirect URL, navigate to that page
