// src/app/admin/user/company/[id]/page.tsx
"use client";
...
export default function AdminCompanyView() {
  ...
  const [newStatus, setNewStatus] = useState<"ACTIVE" | "SUSPEND" | null>(
    null,
  );
  ...
  const confirmStatusChange = async () => {
    ...
    try {
      let response;
      if (newStatus === "ACTIVE") {
        response = await adminCompanyProfileAPI.activeCompany(
          company.userId || company.id || "",
        );
      } else {
        response = await adminCompanyProfileAPI.suspendCompany(
          company.userId || company.id || "",
        );
      }
      ...
      if (apiResponse.success) {
        setCompany({ ...company, isVerified: newStatus == "ACTIVE" });
      ...
      <AlertDialog open={showStatusDialog} onOpenChange={setShowStatusDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to change this company&apos;s activation to{" "}
