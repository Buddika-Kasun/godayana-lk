package com.godayana.visa.service.impl;
...
import com.godayana.visa.repository.VisaPostRepository;
...
//    }
    ...
    public PostImageUploadResponse uploadImage(UUID adminId, MultipartFile file) {
        ...
        try {
            ...
            return uploadJobImageToFileService(file, "visa-post-image", adminId.toString());
    ...
    private PostImageUploadResponse uploadJobImageToFileService(MultipartFile file, String folder, String userId) {
        try {
